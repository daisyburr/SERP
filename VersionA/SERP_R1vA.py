...
#Run 1 Version A
#---------------------------------------------------------
#Experiment description: 3 blocks of 10 pictures each. Cue before each block 
#denoting which form of regulation (Positive reappraisal, negative reappraisal, 
#or Distaction) to use on the block of pictures. Version 1(A) of 3.
#---------------------------------------------------------
...
data_path = "InstrRun1vA_"+str(subj_id)+".csv";
...
num_stim = 30;
num_reps = 10;
PhotoStim_List = ["5535.jpg", "7004.jpg", "7006.jpg", "7003.jpg", "7640.jpg", "7055.jpg", "7491.jpg", "7035.jpg", "7045.jpg", "9921.jpg", "9181.jpg", "3400.jpg", "6838.jpg", "6360.jpg", "6821.jpg", "6560.jpg", "6510.jpg", "2141.jpg", "6230.jpg", "9410.jpg", "3120.jpg", "3261.jpg", "3180.jpg", "6350.jpg", "3191.jpg", "3130.jpg", "3016.jpg", "3225.jpg", "3100.jpg", "3102.jpg"];
...
Cue_filename ="/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/"+ Cue
...
filename = "/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/QuestStim/" + QuesStim_List[2]
...
for i in range(0, num_reps):
    filename ="/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/IAPS/"+ PhotoBlock1[i]
    img = psychopy.visual.ImageStim(
        win=win,
        image=filename,
        units="pix"
...
filename = "/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/QuestStim/" +QuesStim_List[0]
img = psychopy.visual.ImageStim(
        win=win,
        image=filename,
        units="pix"
...
for i in range(0,num_reps):
    filename ="/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/IAPS/"+ PhotoBlock2[i]
    img = psychopy.visual.ImageStim(
        win=win,
        image=filename,
        units="pix"
...
filename = "/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/QuestStim/" + QuesStim_List[1]
img = psychopy.visual.ImageStim(
        win=win,
        image=filename,
        units="pix"
...
for i in range(0,num_reps):
    filename ="/Users/whalenlab/Dropbox/Dartmouth/whalenlabcomp/Experiments/SERP/IAPS/"+ PhotoBlock3[i]
    img = psychopy.visual.ImageStim(
        win=win,
        image=filename,
        units="pix"
